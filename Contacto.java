...
public class Contacto extends Persona{
    ...
    // Metodo para agregar un telefono a un contacto
    public void agregarTelefono(Telefono tel){
        this.listaTelefonos.add(tel);
    }
    //Metodo para eliminar un telefono de un contacto
    public void eliminarTelefono(Telefono tel){
        this.listaTelefonos.remove(tel);
    }
    //Metodo para devolver todos los telefonos de un tipo dado (M o F).
